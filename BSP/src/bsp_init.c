...
uint8_t wbus_rx_buffer[WBUS_RX_BUFFER_SIZE];
...
void BSP_Init(void)
{
    ...
    BSP_GPIO_NewObject(&app_gpio2, GPIO_INPUT_DEV, APP_CONFIG2_GPIO_Port, APP_CONFIG2_Pin);
...
//    BSP_UART_NewObject(&wbus_obj, &huart3);
//    BSP_UART_ReceiveConfig(&wbus_obj, wbus_rx_buffer, WBUS_RX_BUFFER_SIZE, NULL);
