    ...
    switch(cmd_id)
    {
        ...
        case SHOOT_DATA_CMD_ID:
        {
            memcpy(&speed_heat_data_t, data, sizeof(ext_shoot_data_t));
						fp32 shoot_time = BSP_GetTime_ms();
						delay_time = shoot_time - shoot_start_time;
        }break;
...
/*************************************************
 * Function: RefereeSystem_HeatData_Pointer
 * Description: 获取机器人受击数据
 * Input: 无
 * Return: 机器人受击数据指针
*************************************************/
