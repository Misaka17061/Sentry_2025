...
typedef enum
{
    ...
    OFFLINE_CHASSIS_STEER_MOTOR1,
    OFFLINE_CHASSIS_STEER_MOTOR2,
    OFFLINE_CHASSIS_STEER_MOTOR3,
    OFFLINE_CHASSIS_STEER_MOTOR4,
