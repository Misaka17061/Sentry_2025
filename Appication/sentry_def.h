...
#define GIMBAL_MOTOR_YAW_MESSAGE_ID     MOTOR_5_FEEDBACK_ID     					//Yaw云台电机
#define GIMBAL_MOTOR_PITCH_MESSAGE_ID   MOTOR_6_FEEDBACK_ID     					//Pitch云台电机
/*---------------↓ 射击电机ID ↓---------------*/
...
#define WHEEL_RADIUS                (76.1)    				//轮子半径(mm)
#define WHEEL_PERIMETER             (478)   				//轮子周长(mm)
#define WHEELTRACK                  (338.02)   				//轮距(mm)
#define WHEELBASE                   (338.02)   				//轴距(mm)
...
#define YAW_B_REDUCTION_RATIO       (1.0f)  				//yaw减速比
 ...
 *                                                                   移动控制                                                                         *
 ******************************************************************************/
#define MAX_CHASSIS_VX_SPEED        (1000.0f)
#define MAX_CHASSIS_VY_SPEED        (1000.0f)
...
#define RC_GIMBAL_MOVE_RATIO_YAW    0.001f         				 //yaw移动比例   //0.001
#define RC_PLATFORM_MOVE_RATIO_YAW  0.0005f         				 //yaw移动比例   //0.001
/*---------------↓ 鼠标键盘 ↓---------------*/
